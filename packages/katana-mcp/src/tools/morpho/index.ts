...
import { registerBuildVaultWithdraw } from "./build-vault-withdraw.js";
import { registerGetVaultDetail } from "./get-vault-detail.js";
...
export function registerMorphoTools(server: McpServer) {
  ...
  registerGetVaultDetail(server); // get_morpho_vault_detail
  ...
  registerBuildVaultWithdraw(server); // build_morpho_vault_withdraw
